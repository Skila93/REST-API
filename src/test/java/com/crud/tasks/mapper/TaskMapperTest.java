...
class TaskMapperTest {
    ...
    void testMapToTaskDtoList() {
        //Given
        Task task1 = new Task(1L, "Test1", "Test content");
        Task task2 = new Task(2L, "Test2", "Test content");
        List<Task> taskList = new ArrayList<>();
        taskList.add(task1);
        taskList.add(task2);

        TaskDto taskDto1 = new TaskDto(1L, "Test1", "Test content");
        TaskDto taskDto2 = new TaskDto(2L, "Test2", "Test content");
